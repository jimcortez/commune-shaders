/*{
    ...
    "INPUTS": [
        ...
        { "NAME": "mat_radiusScale",     "TYPE": "float", "DEFAULT": 0.07,  "MIN": 0.01, "MAX": 0.2 },
        { "NAME": "mat_spacing",         "TYPE": "float", "DEFAULT": 0.04,  "MIN": 0.01, "MAX": 0.1 },
        { "NAME": "mat_colorVariation",  "TYPE": "float", "DEFAULT": 0.6,   "MIN": 0.2,  "MAX": 1.0 },
        { "NAME": "mat_shapeCount",      "TYPE": "float", "DEFAULT": 60.0,  "MIN": 10.0, "MAX": 100.0 },
        ...
        { "NAME": "mat_animationSpeed",  "TYPE": "float", "DEFAULT": 20.0,  "MIN": 5.0,  "MAX": 50.0 }
    ]
}*/
...
vec4 materialColorForPixel(vec2 texCoord) {
    ...
    float iTime = TIME / mat_animationSpeed;
    ...
    for (int i = 0; i < MAX_ITER; i++) {
        ...
        col = mix(col, vec3(0.0), smoothstep(mat_circleSharpness, 0.0, abs(d)));
    }
