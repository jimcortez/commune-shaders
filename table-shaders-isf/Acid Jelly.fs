/*{
    ...
    "INPUTS": [
        ...
        { "NAME": "mat_contrast",      "TYPE": "float", "DEFAULT": 0.13,  "MIN": 0.08, "MAX": 0.16 },
        ...
        { "NAME": "mat_sinMul",        "TYPE": "float", "DEFAULT": 0.0,   "MIN": -10.0,"MAX": 10.0 },
        { "NAME": "mat_cosMul",        "TYPE": "float", "DEFAULT": 2.38,  "MIN": -10.0,"MAX": 10.0 },
...
vec4 materialColorForPixel(vec2 texCoord) {
    ...
    for (float i = 0.0; i < ORBS; i++) {
        uv.x += mat_sinMul * sin(uv.y * mat_yMul + TIME * mat_xSpeed) + cos(uv.y / mat_yDivide - TIME);
        uv.y += mat_cosMul * cos(uv.x * mat_xMul - TIME * mat_ySpeed) - sin(uv.x / mat_xDivide - TIME);
