/*{
    "CATEGORIES": [],
    "CREDIT": "Jim Cortez - Commune Project (Original: mojovideotech, based on shadertoy.com/view/ltBXRc by phil)",
    "DESCRIPTION": "Creates a rainbow glow ring effect with animated noise and color blending. Features center position, noise, rate, radius controls, amplitude, multiplier, warp, and glow intensity for dynamic ring animations.",
    "INPUTS": [
        {"NAME": "center", "TYPE": "point2D", "DEFAULT": [0.5, 0.5], "MAX": [1.0, 1.0], "MIN": [0.0, 0.0]},
        {"NAME": "noise", "TYPE": "float", "DEFAULT": 0.01, "MIN": 0.0, "MAX": 1.0},
        {"NAME": "rate", "TYPE": "float", "DEFAULT": 1.5, "MIN": -5.0, "MAX": 5.0},
        {"NAME": "radius1", "TYPE": "float", "DEFAULT": 0.25, "MIN": 0.00999, "MAX": 0.4999},
        {"NAME": "radius2", "TYPE": "float", "DEFAULT": 0.333, "MIN": 0.01, "MAX": 0.5},
        {"NAME": "amp", "TYPE": "float", "DEFAULT": 0.01, "MIN": 0.005, "MAX": 0.5},
        {"NAME": "mult", "TYPE": "float", "DEFAULT": 1.0, "MIN": 1.0, "MAX": 9.0},
        {"NAME": "warp", "TYPE": "float", "DEFAULT": 5.0, "MIN": 0.0, "MAX": 16.0},
        {"NAME": "glow", "TYPE": "float", "DEFAULT": 3.0, "MIN": 1.0, "MAX": 6.0}
    ],
    "ISFVSN": "2"
}*/
