/*{
    ...
    "DESCRIPTION": "Generates a stunning cosmic flare effect with dynamic ray patterns and fractal noise. Creates realistic lens flare simulations with customizable brightness, ray density, and color controls, producing dramatic light effects that mimic astronomical phenomena and camera artifacts.",
    "INPUTS": [
        {
            "DEFAULT": 2,
            "MAX": 5,
...
- Original Shader: Flaring by nimitz (https://www.shadertoy.com/view/lsSGzy)
- Source: Originally sourced from editor.isf.video - CosmicFlare by mojovideotech
- Description: Cosmic flare effect with fractal noise and ray density controls
- License: Unknown (based on Shadertoy license)
- Features: Brightness, ray density, gamma, curvature, frequency, and RGB color controls
*/
