/*{
	...
	"DESCRIPTION": "Creates a hexagonal prism raymarching effect with hue shift. Features speed control, raymarching, and dynamic hue shifting for a vibrant, geometric 3D scene.",
	"INPUTS": [
		{"NAME": "speed", "TYPE": "float", "DEFAULT": 1.0, "MIN": 0.0, "MAX": 2.0}
	],
	"ISFVSN": "2",
	"PASSES": [
...
- Source: Originally sourced from editor.isf.video - HexPattern by inigo quilez
- Description: Hexagonal prism raymarching with hue shift
