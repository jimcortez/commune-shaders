/*{
    ...
    "DESCRIPTION": "Creates prime waves effect using prime number-based noise patterns. Features center position, rate, zoom, depth, and prime number controls for mathematical wave patterns.",
    "INPUTS": [
        {
            "NAME": "center",
            "TYPE": "point2D",
