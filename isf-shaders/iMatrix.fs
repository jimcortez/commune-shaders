/*{
	"CATEGORIES": [],
	"CREDIT": "Jim Cortez - Commune Project (Original: mojovideotech, based on BigWings)",
	"DESCRIPTION": "Creates an animated matrix effect based on The Universe Within by BigWings. Features seeds, scale, rate, zoom, line, flash, mirror, color, and cycle controls for dynamic matrix animations.",
	"INPUTS": [
...
- Based on: The Universe Within by Martijn Steinrucken aka BigWings (2018)
- Source: Originally sourced from editor.isf.video - iMatrix by mojovideotech
- Description: Animated matrix based on The Universe Within by BigWings
- License: Creative Commons Attribution-NonCommercial-ShareAlike 3.0
- Features: Animated matrix, seeds, scale, rate, zoom, line, flash, mirror, color, cycle controls
*/
